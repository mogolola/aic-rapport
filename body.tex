...
Figure \ref{fig:fusion_details} zooms in the fusion layers and explains how neurons are connected before training the fusion network. After fusing, the connections in previous stream networks(blue, yellow and green) are retained, no connection exists between different streams. The fusion output (red in Figure \ref{fig:fusion_details}) is the average of the three stream networks' outputs. 
