...
In this section we compare our fusion model CNN on 24 hours forecast with the existing forecasting models: OFCL and BCD5. In addition, we define the baseline prediction as equal to four times the last displacement (from $t-6h$ to $t$). 
